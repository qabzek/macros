...
export STREFMULTCORR=$PICODST/../StRefMultCorr
export PATH=${STREFMULTCORR}':'${PATH}
export LD_LIBRARY_PATH=${STREFMULTCORR}':'${LD_LIBRARY_PATH}
# echo STREFMULTCORR = $STREFMULTCORR
